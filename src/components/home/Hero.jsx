    ...
    return (
        <div className=''>
            ...
            <div className="container pt-24">
                ...
                <p className='font-normal text-custom-xl text-white text-center'><span className='font-bold italic text-light-blue'>Dominate</span> Your Category on Amazon</p>
                ...
                <CommonButton className='mt-12 mx-auto' text='DISCOVER OUR STRATEGY' />
